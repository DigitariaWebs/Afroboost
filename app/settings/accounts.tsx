...
export default function AccountsSettings() {
  ...
  return (
    <ScreenContainer scroll>
      ...
      <View style={{ gap: 10 }}>
        <MockOAuthRow provider="facebook" label="Facebook" connected={mockBusiness.connectedAccounts.facebook} />
        <MockOAuthRow provider="instagram" label="Instagram" connected={mockBusiness.connectedAccounts.instagram} />
